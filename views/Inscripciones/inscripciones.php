...
?>
    ...
    <body class="sb-nav-fixed">
        ...
        <!--modales-->
        <div class="modal fade" data-bs-backdrop= "static" data-bs-keyboard="false" id="modalInscripciones" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
